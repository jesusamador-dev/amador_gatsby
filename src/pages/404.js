...
import astronauta from '../images/astronauta.svg'

const NotFoundPage = () => (
    <>
        <main className="permission_denied">
            <div className="denied__wrapper">
                ...
                <h3>
                    Lo mejor será volver al inicio, presiona&nbsp;
                    <Link to="/">
                        aquí
                    </Link>
                </h3>
                <img id="astronaut" src={astronauta} alt="Astronauta" />
                {/* <img id='planet' src= alt='Planeta' /> */}
